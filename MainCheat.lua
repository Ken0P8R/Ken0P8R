...
gg.alert("⚠️Invalid Password⚠️\n\nIncorrect Password or Password Has Expired, Please Check Telegram Channel For New Information") 
print("B Indo Gua 73 Anjg") 
os.exit() 
end
...
function Mract() 
gg.alert("Sorry This Feature Not For Public")
end
